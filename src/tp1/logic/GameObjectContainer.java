...
public class GameObjectContainer {
	...
	// Funci�n que devuelve el objeto de la lista que tenga la posici�n dada por par�metro
	...
	// M�todo que comprueba para cada alien o bomba si fue atacado por el laser o el shockWave
